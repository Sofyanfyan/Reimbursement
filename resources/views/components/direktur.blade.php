            ...
            <nav class="mt-2">
              ...
              with font-awesome or any other icon font library -->
                    <li class="nav-item menu-open">
                        <a href="#" class="nav-link {{session('pages') === 'list' ? '' : 'active'}}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/dasboard-direktur" class="nav-link {{session('pages') === 'create' ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Create user</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/dasboard-direktur/users" class="nav-link {{session('pages') === 'alluser' ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>All User</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/dasboard-direktur/list" class="nav-link {{session('pages') === 'list' ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>List</p>
                                </a>
                            </li>
