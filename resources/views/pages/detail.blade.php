...
<div class="d-flex justify-content-center">
   ...
   <div class="card mt-4" style="width: 40%;">
      ...
      <div class="card-body">
        <a href="{{url('dasboard-finance')}}/{{$data->id}}/approve" class="card-link">Approve</a>
        <a href="{{url('dasboard-finance')}}/{{$data->id}}/reject"  class="card-link">Reject</a>
      </div>
      @endif
   </div>
</div>
